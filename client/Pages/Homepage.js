...
const Homepage = ({setSelectedBid, selectedBid,  onRowClick, setIsSidebarVisible, setSelectedBidVersion, setSelectedBidLifecycle }) => {
    ...
    <div>
      {!redirectToCosting && (
        <TabPanel onTabChange={handleTabChange}>
          ...
          <BidTable setIsSidebarVisible={setIsSidebarVisible} 
            setRedirectToCosting={setRedirectToCosting} 
            setSelectedBid={setSelectedBid} 
            setSelectedBidVersion={setSelectedBidVersion} 
            selectedBid = {selectedBid} 
