...
const BidTable = ({ setRedirectToCosting, setSelectedBid, setSelectedBidVersion, setIsSidebarVisible, selectedBid }) => {
    ...
    if (el.current && !tabulator.current) {
      ...
      if (tabulator.current) {
        tabulator.current.on("rowClick", function (e, row) {
          ...
          //console.log("Bid Number", typeof(selectedBid)); // Set the selected Bid#
