...
async function get_lov_state(filterVariable) {
    try {
        ...
        query += ` WHERE IsActive=1 AND [Tenant_CD] = '${filterVariable}' AND [Category_CD] = 'ST' ORDER BY SORTORDER ASC`; // Modify [SomeColumn] with the actual column name
        ...
        console.error('SQL Error: 14', error);
        throw error;
    } finally {
        await sql.close();
    }
}
module.exports = get_lov_state;