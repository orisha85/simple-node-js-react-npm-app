...
const config_url = require('./data/config_url');
const get_projects = require('./data/get_projects');
const get_tenants = require('./data/get_tenants');
const get_lov_activity = require('./data/get_lov_activity');
const get_lov_bidtype = require('./data/get_lov_bidtype');
const get_lov_jobtype = require('./data/get_lov_jobtype');
const get_lov_region = require('./data/get_lov_region');
const get_lov_skufamily = require('./data/get_lov_skufamily');
const get_lov_state = require('./data/get_lov_state');
const get_lov_town = require('./data/get_lov_town');
const get_lov_service_hub = require('./data/get_lov_service_hub');
const get_lov_region_state = require('./data/get_lov_region_state');
const get_labourstandards = require('./data/get_labourstandards');
const get_ProjectVersion = require('./data/get_projectVersion');
const get_project_information = require('./data/get_project_information');
const get_skuMaterial = require('./data/get_skuMaterial'); 
const get_cost_line_item = require('./data/get_projectCostLineItem');
const get_ProjectPriceLineItem = require('./data/get_projectPriceLineItem');
//const get_ProjectCostLineItem = require('./src/data/get_projectCostLineItem');
const get_ProjectCostHeader = require('./data/get_ProjectCostHeader');
const get_ProjectCostMobalization = require('./data/get_projectCostMobalization');
const get_lov_sku_group = require('./data/get_lov_sku_group');
const get_drivedistance = require('./data/get_drivedistance');
const get_lov_town_region = require('./data/get_lov_town_region');
//const get_projectValuation = require('./src/data/get_projectValuation');
const get_projectLifecycle = require('./data/get_projectLifecycle');
const get_projectPriceSummary = require('./data/get_projectPriceSummary');
//const get_lookup_UoM = require('./src/data/get_lov_reference');
const get_projectValuation = require('./data/get_projectValuation');
const get_ratetypevalue = require('./data/get_ratetypevalue');
const lookup_labourstandards = require('./data/lookup_labourstandards');
const lookup_skuMaterial = require('./data/lookup_skuMaterial');
const lookup_UoMConversion = require('./data/lookup_UoMConversion');
const lookup_drivedistance = require('./data/lookup_drivedistance');
//const lookup_lifecycleDetails= require('./src/data/lookup_lifecycleDetails');

const merge_project = require('./data/merge_project');
const merge_projectVersion = require('./data/merge_projectVersion');
const merge_projectCostHeader = require('./data/merge_projectCostHeader');
const merge_projectCostLineItem = require('./data/merge_projectCostLineItem');
const merge_projectCostMobalization = require('./data/merge_projectCostMobalization');
const merge_projectPriceSummary = require('./data/merge_projectPriceSummary');
//const get_lov_project = require('./get_tenants');

const update_projectPriceLineItem = require('./data/update_projectPriceLineItem');
const update_projectVersion = require('./data/update_projectVersion');
const delete_projectCostLineItem = require('./data/delete_projectCostLineItem');
const create_new_project_id = require('./data/create_new_project_id');
const exec_projectPriceLine = require('./data/exec_projectPriceLine');
