...
const get_projects = require('./data/api/get_projects');
const get_tenants = require('./data/api/get_tenants');
const get_lov_activity = require('./data/api/get_lov_activity');
const get_lov_bidtype = require('./data/api/get_lov_bidtype');
const get_lov_jobtype = require('./data/api/get_lov_jobtype');
const get_lov_region = require('./data/api/get_lov_region');
const get_lov_skufamily = require('./data/api/get_lov_skufamily');
const get_lov_state = require('./data/api/get_lov_state');
const get_lov_town = require('./data/api/get_lov_town');
const get_lov_service_hub = require('./data/api/get_lov_service_hub');
const get_lov_region_state = require('./data/api/get_lov_region_state');
const get_labourstandards = require('./data/api/get_labourstandards');
const get_ProjectVersion = require('./data/api/get_projectVersion');
const get_project_information = require('./data/api/get_project_information');
const get_skuMaterial = require('./data/api/get_skuMaterial'); 
const get_cost_line_item = require('./data/api/get_projectCostLineItem');
const get_ProjectPriceLineItem = require('./data/api/get_projectPriceLineItem');
//const get_ProjectCostLineItem = require('./data/api/get_projectCostLineItem');
const get_ProjectCostMobalization = require('./data/api/get_projectCostMobalization');
const get_lov_sku_group = require('./data/api/get_lov_sku_group');
const get_drivedistance = require('./data/api/get_drivedistance');
const get_lov_town_region = require('./data/api/get_lov_town_region');
//const get_projectValuation = require('./data/api/get_projectValuation');
const get_projectLifecycle = require('./data/api/get_projectLifecycle');
const get_projectPriceSummary = require('./data/api/get_projectPriceSummary');
//const get_lookup_UoM = require('./data/api/get_lov_reference');
const get_projectValuation = require('./data/api/get_projectValuation');
const lookup_labourstandards = require('./data/api/lookup_labourstandards');
const lookup_skuMaterial = require('./data/api/lookup_skuMaterial');
const lookup_UoMConversion = require('./data/api/lookup_UoMConversion');
const lookup_drivedistance = require('./data/api/lookup_drivedistance');
const lookup_lifecycleDetails= require('./data/api/lookup_lifecycleDetails');

const merge_project = require('./data/api/merge_project');
const merge_projectVersion = require('./data/api/merge_projectVersion');
const merge_projectCostHeader = require('./data/api/merge_projectCostHeader');
const merge_projectCostLineItem = require('./data/api/merge_projectCostLineItem');
const merge_projectCostMobalization = require('./data/api/merge_projectCostMobalization');
const merge_projectPriceSummary = require('./data/api/merge_projectPriceSummary');
//const get_lov_project = require('./get_tenants');

const update_projectPriceLineItem = require('./data/api/update_projectPriceLineItem');
const update_projectVersion = require('./data/api/update_projectVersion');
const delete_projectCostLineItem = require('./data/api/delete_projectCostLineItem');
const create_new_project_id = require('./data/api/create_new_project_id');
const exec_projectPriceLine = require('./data/api/exec_projectPriceLine');
